<div class="services-container">
    ...
    <div class="services-grid">
        ...
        <div class="services-element">
            <div class="icon-circle">
                <img src="<?php echo get_template_directory_uri()."/images/rocket.png" ?>" alt="@">
            </div>
            <h3>Trainings</h3>
            <p>Our technical advisers oversee projects, guide clients through development, and teach them to solve technical issues.</p>
            <a class="button-text" href="#">Learn More  <img src="<?php echo get_template_directory_uri()."/images/arrow-right.png" ?>" alt=""></a>
        </div>
        <div class="services-element">
            <div class="icon-circle">
                <img src="<?php echo get_template_directory_uri()."/images/user-plus.png" ?>" alt="@">
            </div>
            <h3>Payroll & HR</h3>
            <p>Our team can help, offering a wide range of practical services and expert advice tailored to individual client needs.</p>
            <a class="button-text" href="#">Learn More  <img src="<?php echo get_template_directory_uri()."/images/arrow-right.png" ?>" alt=""></a>
        </div>
        <div class="services-element">
            <div class="icon-circle">
                <img src="<?php echo get_template_directory_uri()."/images/inbox.png" ?>" alt="@">
            </div>
            <h3>Bookkeeping acc. to IFRS/OIC</h3>
            <p>Cesca Accounting partners with Sage to offer cloud-based software, from full bookkeeping outsourcing to staff support for monthly reports.</p>
            <a class="button-text" href="#">Learn More  <img src="<?php echo get_template_directory_uri()."/images/arrow-right.png" ?>" alt=""></a>
        </div>
    </div>
</div>    
